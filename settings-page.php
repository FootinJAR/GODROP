...
<div class="settings">
        ...
        <div class="settings-content">
                ...
                <fieldset class="fieldset-profile">
                        ...
                        <div class="form-inner">
                            <div class="form-line">
                                <div class="wrap-input">
                                    <input type="text" rel="get-trade-link" id="par2" name="par2" placeholder="Например: https://steamcommunity.com/tradeoffer/new/?partner=204584087&token=uClGP871">
                                </div>
                            </div>
                    ...
                    <!--div class="form-line">
                        <div class="wrap-label">
                            <label for="par3">Ссылка на обмен в Steam:</label>
                        </div>
                        <div class="form-inner">
                            <div class="wrap-input">
