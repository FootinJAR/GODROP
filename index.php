...
<body class="ezpz-currency-ru"  onload="setInterval('chat.update()', 1000)" id="main-page">

<div class="chat" style="height: auto; z-index: 1000;">
  <header>
    <h2 class="title"><a>ЧАТ</a></h2>
    <ul class="tools"><li><a class="closech" >↑</a> <a class="closechs hidden" >↓</a></li></ul>
  </header>
	<div id="page-wrap" class="hjgf hidden">
		...
		<?php
						...
						echo '<div id="otpsoob"><div style="padding-top: 7px;">
									<a class="ezpz-loginas" style="font-size: 12px;border: 2px solid #db073d;margin: auto;padding-top: 12px;width: 230px;min-height: 27px;height: 27px;" href="/?login">Авторизоваться в STEAM</a>
								</div></div>';
						} else {
    ...
    <div class="token-block promo hidden">
        ...
        <div class="jackpot">
            ...
            <div class="form-get-link">
                ...
                <div class="form-line">
                    <div class="wrap-input"><input rel="get-trade-link" type="text" name="link" placeholder="Например:https://steamcommunity.com/tradeoffer/new/?partner=222666469&token=Y9N5xGHr"></div>
                </div>
                <div class="buttons">
        ...
        <div class="details-wrap <?php echo $detailsWrapClass; ?>">
            <div class="details type-second">
                <div class="details-left">
                    ...
                    <div><b>Мин. ставка 1₽</b>, <!--b>макс. ставка 400$</-->максимум предметов 20.</div>
